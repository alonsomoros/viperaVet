...
/**
 * Programador de tareas para sincronización automática de datos de razas de gato.
 * 
...
public class CatApiDataScheduler implements ApplicationRunner {
    ...
    /**
     * Ejecuta la sincronización programada de razas de gato desde la API externa.
     * 
    ...
    /**
     * Ejecuta la sincronización inicial de razas de gato al arrancar la aplicación.
     * 
